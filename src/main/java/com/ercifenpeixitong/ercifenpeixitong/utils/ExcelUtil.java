...
import com.ercifenpeixitong.ercifenpeixitong.exceptions.ExcelException;
import jxl.Cell;
import jxl.Sheet;
import jxl.Workbook;
...
public class ExcelUtil {
     ...
     * @param list      数据源
     * @param mapping      类的英文属性和Excel中的中文列名的对应关系
        ...
        try {
            ...
            for(int i=0; i<sheetNum; i++){
                ...
                if(1==sheetNum){
                    ...
                    fillSheet(sheet, list, mapping, 0, list.size()-1);
                    ...
                    //填充工作表
                    fillSheet(sheet, list, mapping, firstIndex, lastIndex);
                }
            }
